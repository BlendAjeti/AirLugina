...
<head>
    ...
    <title>CARD</title>
    <link rel="stylesheet" href="/AirLugina/Assets/card.css">
</head>
<body>
    <div class="container">
        <div class="navbar">
        ...
        <div class="ticket-price">
            <div class="ticket">
                ...
                <div class="plane-accesories">
                    <div class="e-logo">
                        <img src="/AirLugina/Assets/Images/Emirtaes-logo.png" alt="Emirate-logo">
                    </div>
                    <div class="wifi-logo">
                        <img src="/AirLugina/Assets/Images/Accessories.png" alt="Accessories">
                    </div>
                </div>
                <div class="plane-arrive">
                    ...
                    <div class="plane-direction">
                        <img src="/AirLugina/Assets/Images/Plane-direction.png" alt="plane-direction">
                    </div>
                    <div class="newark">
                        <div class="inline">
                            <h2>12:00 pm</h2>
            ...
            <div class="price-fee">
               <div class="pricee">
                <div class="ecoonomyf">
                    <div class="plane-img">
                        <img src="/AirLugina/Assets/Images/big-plane-card.png" alt="plane">
                    </div>
                    <div class="economy">
                        <p>Economy</p>
        ...
        <div class="add-new" id="karta">
            <div class="new-card">
                <div class="big-text">
                    ...
                    <div class="x-img">
                        <img src="/AirLugina/Assets/Images/x-vector.png" alt="x-vector">
                    </div>
                </div>
                ...
                <form action="#">
                    <div class="c-number">
                        <fieldset>
                            ...
                            <img src="/AirLugina/Assets/Images/Visa.png" alt="visa">
                        </fieldset>
